...
class Phone //Class.forName();  	Book.java/Dog.java/apple.java
{
 ...
 * 笔记见后
 * 1	标准访问,请问先打印短信还是邮件?
 * 2	发短信方法先sleep四秒钟,请问先打印短信还是邮件?
 * 3	新增加close普通方法,请问先打印短信还是close?
 * 4	有两部手机,请问先打印短信还是邮件?
 * 5	两个静态同步方法,同一部手机,请问先打印短信还是邮件?
 * 6	两个静态同步方法,2部手机,请问先打印短信还是邮件?
 * 7	一个普通同步方法,一个静态同步方法,同一部手机,请问先打印短信还是邮件?
